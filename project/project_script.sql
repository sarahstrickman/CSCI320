...
INSERT INTO QUESTION ( 'GENDEROPT [S]',
...
INSERT INTO ANSWER(QKEY, QID, ANSWER) VALUES (
	'100604', 'GENDEROPT [S]', 'yes'
)

INSERT INTO ANSWER(QKEY, QID, ANSWER) VALUES (
	'103538', 'GENDEROPT [S]', 'yes'
)

INSERT INTO ANSWER(QKEY, QID, ANSWER) VALUES (
	'100598', 'VTSYSSEC_US [S]', 'somewhat confident'
)

INSERT INTO ANSWER(QKEY, QID, ANSWER) VALUES (
	'651945', 'CANDHOUSAT [S]', 'somewhat satisfied'
)

INSERT INTO ANSWER(QKEY, QID, ANSWER) VALUES (
	'100363', 'CANDHOUSAT [S]', 'not too satisfied'
)

INSERT INTO ANSWER(QKEY, QID, ANSWER) VALUES (
	'102198', 'CANDHOUSAT [S]', 'not too satisfied'
)
